...
export class FontRender {
    ...
    private makePolygon(st: number[], ed: number[]): number[] {
        ...
        /*
        let top = this.triangleStrip([
            [st[0], st[1], 0.1],
            [st[0] + sx2, st[1] + sy2, 0.2],
            [st[0] + sx1, st[1] + sy1, 0.2],
            [ed[0] + ex2, ed[1] + ey2, 0.2],
            [ed[0] + ex1, ed[1] + ey1, 0.2],
            [ed[0], ed[1], 0.1]
        ], [1.2, 1.0, 0.9]);
        let bottom = this.triangleStrip([
            [st[0], st[1], -0.1],
            [st[0] + sx1, st[1] + sy1, -0.2],
            [st[0] + sx2, st[1] + sy2, -0.2],
            [ed[0] + ex1, ed[1] + ey1, -0.2],
